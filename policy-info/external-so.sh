...
# Usage: $0 <list of directory names>

# Prints a list of all shared libraries that are *needed* by some file in the
# given directories, but are not *provided* in the given directories.
